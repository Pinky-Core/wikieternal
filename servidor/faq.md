---
description: ¿Tienes más preguntas? Iremos actualizando las preguntas más frecuentes.
---

# ❓ FAQ

## <mark style="color:blue;">¿Cómo cambio mi contraseña en el servidor?</mark>

Es muy sencillo, comando **"/changepassword (antigua contraseña) (nueva contraseña)"** sigue estos pasos:\
\
&#x20; 1\. Coloque su contraseña antigua, en esta ocasión elegiré "Pepito123" luego tendra que colocar su contraseña nueva, que sea más segura "Pepito7682"  _¡Esto es un ejemplo!_
...
## <mark style="color:blue;">¿Cómo activar el modo premium?</mark>
...
## <mark style="color:blue;">¿Cómo se vota en el servidor?</mark>
...
Si eres de bedrock y si sabemos no puedes hacer click a enlaces en el chat, deberás ir a nuestro [Discord](https://discord.satipocraft.net) y usar <mark style="color:purple;">**!votar**</mark> en cualquier canal de nuestro Discord.

## <mark style="color:blue;">¿Cómo se entra en bedrock al servidor?</mark>

1. Añadir nuevo servidor
2. Nombre del servidor: Cualquier cosa vale.
3. En ip pones <mark style="color:purple;">**mc.satipocraft.net**</mark>
...
## <mark style="color:blue;">¿Cómo se abre ticket en discord?</mark>
...
## <mark style="color:blue;">¿Por qué no me llego nada de lo que compre en la tienda?</mark>
...
Deberás contactar con soporte en [discord](https://discord.satipocraft.net) para que te lo arreglen, para las proximas compras ya sabras que hacer.



{% hint style="success" %}
Si crees que falta alguna pregunta en nuestro FAQ de la Wiki, puedes hacer una sugerencia en [discord](https://discord.satipocraft.net).
{% endhint %}
